...
def main():
    ...
    count_vacancy = 5 #int(input('Введите количество страниц для поиска на двух сайтах в каждой странице по 10 вакансий из двух сайтов в итоге 20 вакансий с одной страницы>>>'))
    for i in range(count_vacancy):
        ...
        for j in range(10):
            ...
            writing_to_a_file(list(vacancy_hh.__repr__()))
            writing_to_a_file(list(vacancy_ss.__repr__()))
            a+=4
